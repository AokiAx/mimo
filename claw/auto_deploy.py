...
async def run_deploy_async(account_filename: str, force: bool = False) -> None:
    ...
    try:
        ...
        while True:
            ...
            # 429 from create means upstream capacity/rate-limit pressure.
            # Retry all create 429 variants within the budget; the localized
            # message text changes between "pool full" and "too many requests".
            ...
            log.log(
                f"⏳ MiMo 创建限流/容量饱和（429），{sleep_s:.1f}s 后重试"
